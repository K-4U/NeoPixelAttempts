...
ExpandedNeoPixel jewel =
    ExpandedNeoPixel(MAX_PIXELS, LED_DATA_PIN, NEO_GRB + NEO_KHZ800);
LedMode* modes[] = {new Breathing(jewel, jewel.Color(80, 0, 80),
                                  jewel.Color(255, 0, 255), 1000),
                    new RainbowWheel(jewel), new Fire(jewel),
                    new Breathing(jewel, jewel.Color(128, 128, 0),
                                  jewel.Color(0, 255, 255), 1000),
                    new Breathing(jewel, jewel.Color(0, 128, 0),
                                  jewel.Color(0, 255, 0), 10000)};
