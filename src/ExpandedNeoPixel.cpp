...
void ExpandedNeoPixel::setPixelColorWithDelay(uint16_t pixelIndex,
...
void ExpandedNeoPixel::setAllPixelsColorWithDelay(uint32_t targetColor,
                                                  uint32_t delayTime) {
...
void ExpandedNeoPixel::setPixelColor(uint16_t pixelIndex,
                                     uint32_t targetColor) {
...
bool ExpandedNeoPixel::isPixelMoving(uint16_t pixelIndex) {
    return ledRamps[pixelIndex].red.isRunning() ||
           ledRamps[pixelIndex].green.isRunning() ||
           ledRamps[pixelIndex].blue.isRunning();
}
